...
/////////////////
const BotName = 'Kyroo Bot☄'; 
const tiktok = 'tiktok.com/@ken_mengzgg'; 
const instagram = 'https://www.instagram.com/khairul_anwar233?igsh=dmQybzI0OXBzamho'; 
const kapanbotaktif = 'SETIAP HARI KECUALI PUKUL 10 UDAH GAK AKTIF YA'; 
const youtube = 'https://www.youtube.com/@ken-xv9do';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by:kyroohavecounter')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by:kyroohavecounter`)
})
